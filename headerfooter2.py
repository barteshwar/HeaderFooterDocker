...
#video_clip = VideoFileClip("C:\\Users\\Dell\\Downloads\\scraper\\horz.mp4")
    ...
    header = text_clip(header_text_split,font_family="oswald",align='center',font_height = header_fontsize, fill_color=(100,155,255)).set_duration(video_clip.duration)
    ...
    header = text_clip(header_text_split,font_family="oswald",font_height = header_fontsize, align='center',fill_color=(100,155,255)).set_duration(video_clip.duration)
    ...
    footer_fontsize=20
    footer = text_clip(footer_text_split,font_family="oswald",align='center',font_height=footer_fontsize, fill_color=(100,155,255)).set_duration(video_clip.duration)
